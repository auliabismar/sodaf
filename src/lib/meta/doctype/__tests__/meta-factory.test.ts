...
describe('MetaFactory', () => {
	...
	describe('create', () => {
		...
		it('should throw error for invalid DocType', async () => {
			const invalidDocType = null as any;

			await expect(MetaFactory.create(invalidDocType))
				.rejects.toThrow(DocTypeError);
		});

		it('should throw error for DocType without name', async () => {
		...
		it('should throw error for DocType without module', async () => {
			const invalidDocType = {
				name: 'TestDocType',
				fields: [],
				permissions: []
		...
		it('should throw error for DocType without fields array', async () => {
			const invalidDocType = {
				name: 'TestDocType',
				module: 'TestModule',
				fields: null as any,
		...
		it('should throw error for DocType without permissions array', async () => {
			const invalidDocType = {
				name: 'TestDocType',
				module: 'TestModule',
				fields: [],
	...
	describe('Validation', () => {
		...
		it('should reject DocType with invalid structure', async () => {
			const invalidDocType = {
				name: 'InvalidDocType',
				module: 'TestModule',
			...
			await expect(MetaFactory.create(invalidDocType as DocType))
				.rejects.toThrow(DocTypeError);
		});
	});
	...
	describe('Error Handling', () => {
		it('should provide descriptive error messages', async () => {
			await expect(MetaFactory.create(null as any))
				.rejects.toThrow(/Invalid DocType provided/);
		});
